...
values (1, '111', '请叫我凡凡大人', '698d51a19d8a121ce581499d7b701668', 1, 'fanfanlordship', 1, '12345678900', '123456789@qq.com', to_date('29-05-1996', 'dd-mm-yyyy'), '12345678912345678', 0, sysdate);
--插入角色
insert into SYS_ROLE (ID, NAME, STATUS, CREATE_BY, CREATE_TIME) values (1, '超级管理员', 1, 1, sysdate);
--角色-测试人员关联信息
...
values (1, '系统管理', 0, 1, null, 0, 'fa-caret-right', '系统管理', 1, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (2, '权限管理', 1, 1, '/manage/sys/permission', 0, 'fa-caret-right', '系统管理-权限管理', 1, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (3, '系统参数', 1, 1, '/manage/sys/sysparam', 0, 'fa-caret-right', '系统管理-系统参数', 2, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (4, '角色管理', 1, 1, '/manage/sys/role', 0, 'fa-caret-right', '系统管理-角色管理', 3, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (5, '用户管理', 1, 1, '/manage/user/user', 0, 'fa-caret-right', '系统管理-用户管理', 4, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (6, '日志管理', 1, 1, null, 0, 'fa-caret-right', '系统管理-日志管理', 5, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (7, '操作日志', 6, 1, '/manage/sys/log/operate', 0, 'fa-caret-right', '系统管理-日志管理-操作日志', 1, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (8, '异常日志', 6, 1, '/manage/sys/log/error', 0, 'fa-caret-right', '系统管理-日志管理-异常日志', 2, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (9, '登录日志', 6, 1, '/manage/sys/log/login', 0, 'fa-caret-right', '系统管理-日志管理-登录日志', 3, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (10, '按钮权限', 2, 1, '', 1, '', '系统管理-权限管理-按钮权限', 1, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (11, '新增权限', 10, 1, 'system:permission:btn:addAuthority', 1, '', '系统管理-权限管理-按钮权限-新增权限', 1, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (12, '编辑权限', 10, 1, 'system:permission:btn:editAuthority', 1, '', '系统管理-权限管理-按钮权限-编辑菜单', 2, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (13, '系统调试', 0, 1, '', 0, 'fa-caret-right', '系统调试', 2, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (14, 'swagger', 13, 1, '/swagger-ui.html', 0, 'fa-bug', '系统调试-swagger', 1, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (15, '请求耗时', 13, 1, '/test/request/duration', 0, 'fa-bug', '系统调试-请求耗时', 2, 1, sysdate);
insert into SYS_PERMISSION (ID, NAME, SUP_ID, STATUS, PERMISSION, TYPE, ICON, MEMO, SORT, CREATE_BY, CREATE_TIME)
values (16, '系统字典', 1, 1, '/manage/sys/dictionary', 0, 'fa-bug', '系统管理-系统字典', 6, 1, sysdate);
